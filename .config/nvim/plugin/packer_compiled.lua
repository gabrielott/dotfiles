...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["vim-colors-xcode"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vim-colors-xcode",
  ...
  vimwiki = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vimwiki",
